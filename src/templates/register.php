                ...
                <form action="register.php" method="post">
                    ...
                    <div class="control-group">
                        <div class="form-group floating-label-form-group controls mb-0 pb-2">
                            ...
                            <input class="form-control" id="confirmPassword" name="confirmPassword" type="confirmPassword" placeholder="Confirm Password" required="required">
                            <p class="help-block text-danger"></p>
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="form-group">
                        <input type="submit" name="registerUser" class="btn btn-primary btn-xl" value="submit">
                    </div>
                </form>
            </div>
        </div>
